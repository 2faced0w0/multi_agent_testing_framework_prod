...
export default function RepoConfigurator({ targetUrl, setTargetUrl }) {
    ...
    <div className="card" style={{ padding: 20 }}>
      ...
      {expanded && (
        <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
          {/* Target URL Input */}
          <div>
            <p className="section-label" style={{ marginBottom: 6 }}>Target Live URL</p>
            <input
              type="text"
              value={targetUrl}
            ...
            <p style={{ fontSize: '0.7rem', color: 'var(--text-muted)', marginTop: 4 }}>
              The Playwright tests generated by the chat agent will aggressively target this URL.
            </p>
          </div>
          ...
          {/* GitHub Input */}
          <div>
            <p className="section-label" style={{ marginBottom: 6 }}>GitHub Synchronization</p>
            <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', lineHeight: 1.5, marginBottom: 12 }}>
              Paste a GitHub URL to inject application context into the LLM logic generator via ChromaDB.
            </p>
